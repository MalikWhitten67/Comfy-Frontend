...
import { Match, Switch, useState } from "vaderjs"
    ...
    >
      <div className="relative w-full max-w-lg rounded-lg bg-white p-6 shadow-xl">
        ...
        <div className="mb-6 flex items-center gap-2 text-green-600">
          ...
          <span className="font-medium">{isFavorite ? 'Added to favorites' : 'Added to cart'}</span>
        </div>
        ...
        <div className="mb-6 flex gap-4">
          ...
          <div>
            <Switch>
              ...
              <Match when={!isFavorite}> <h3 className="font-medium">{product.name}</h3>
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          >
            {isFavorite ? 'View Favorites' : `View Cart (${c.items.length})`}
          </button>
        </div>
      </div>
    </dialog>
